...
enum Type {
	...
	BSDF_DIFFUSE_ALL = (BSDF_DIFFUSE_REFLECTION | BSDF_DIFFUSE_TRANSMISSION),
	BSDF_SPECULAR_ALL = (BSDF_SPECULAR_REFLECTION | BSDF_SPECULAR_TRANSMISSION),
	BSDF_GLOSSY_ALL = (BSDF_GLOSSY_REFLECTION | BSDF_GLOSSY_TRANSMISSION),
